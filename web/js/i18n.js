...
(function (global) {
  ...
  T.id = inherit(T.en, {
    ...
    'settings.fishBaseHint': 'Kosong = Open API resmi (https://fishaudio.org/api/open/v1).',
    'settings.fishModel': 'Model engine Fish',
    'settings.fishModel.hint': 'Id engine, default fishaudio-s21pro-flash. Terpisah dari id suara.',
    'settings.fishVoice': 'ID suara Fish',
    'settings.fishVoice.hint': 'Kosongkan untuk kloning otomatis dari audio prolog Ryza lokal. Atau tempel id suara yang ada / ketuk kloning di bawah.',
